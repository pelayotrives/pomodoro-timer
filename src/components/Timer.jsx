...
export default function Timer() {
  ...
  const {styles} = useContext(UtilityContext);
  // useState() consts.
  ...
  const sessiontimeConverted = moment
    .duration(sessiontime, "s")
    .format("mm:ss");

  return (
    <div
      style={isActive === false ? styles.styleDivDefault : styles.styleDivToggled}
      className="flex flex-col opacity-100 rounded-3xl shadow-2xl mx-auto my-0 w-2/6 h-4/6 flex content-center items-center justify-center justify-items-center self-center"
    >
      <div className="container flex flex-col content-center items-center justify-center justify-items-center self-center">
        {/* Title and toggle. */}
        <h1
          style={isActive === true ? styles.styleTextDefault : styles.styleTextToggled}
          className="font-onlytitles font-medium text-6xl text-[#F23345]"
        >
          Pomodoro Timer
        </h1>
        ...
        <div
          style={isActive === false ? styles.styleDefault : styles.styleToggled}
          className="circle shadow-reddy w-64 h-64 rounded-full my-8 relative"
        >
          <div className="circle-wrapper absolute top-0 right-0 bottom-0 left-0 flex flex-col justify-center justify-items-center items-center content-center self-center">
            <p
              style={isActive === false ? styles.styleTextDefault : styles.styleTextToggled}
              className="w-full text-center font-onlybody font-regular tracking-wider text-2xl"
            >
              Progress
            </p>
            <p
              style={isActive === false ? styles.styleTextDefault : styles.styleTextToggled}
              className="w-full mt-2 text-center font-onlybody font-regular tracking-wide text-7xl timer"
            >
        ...
        <div className="buttons w-full flex flex-row justify-evenly justify-items-center content-evenly items-center self-center">
          <button
            onClick={eventClick}
            className="flex content-center items-center justify-center justify-items-center self-center text-white font-bold w-3/12 py-2 px-14 rounded-lg bg-[#F23345] hover:bg-[#FB5042] active:bg-[#d62433] border-b-4 border-[#c42330] hover:border-[#d83024] active:border-[#8c0009]"
          >
            Start
          </button>
          <button
        ...
        <div className="break-and-session w-full flex flex-row justify-evenly justify-items-center content-evenly items-center self-center mt-6">
          ...
          <div className="session-section flex flex-col justify-center justify-items-center items-center content-center self-center">
            <div className="session-section-title mb-3">
              <p
                style={isActive === true ? styles.styleTextDefault : styles.styleTextToggled}
                className="font-onlytitles font-medium text-xl text-[#F23345]"
              >
                Session length
              </p>
            </div>
            <div className="session-section-content flex flex-row">
              <button
                ...
                className="flex content-center items-center justify-center justify-items-center self-center text-white font-bold py-2 px-4 rounded-full bg-[#F23345] hover:bg-[#FB5042] active:bg-[#d62433] border-b-2 border-[#c42330] hover:border-[#d83024] active:border-[#8c0009]"
              >
                -
              </button>
              <p
                style={isActive === true ? styles.styleTextDefault : styles.styleTextToggled}
                className="flex content-center items-center justify-center justify-items-center self-center font-onlytitles font-medium text-xl text-[#F23345] w-16"
              >
                {sessionlengthConverted}
              </p>
              <button
